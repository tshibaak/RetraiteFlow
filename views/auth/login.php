...
$googleClientId = $_ENV['GOOGLE_ID'] ?? '';
$googleLoginEnabled = !empty($googleClientId);
        ...
        <div class="login-container">
            ...
            <form action="<?= Router::route('/login') ?>" method="POST" class="login-form" name="loginForm">
                ...
                <?php if ($googleLoginEnabled): ?>
                    ...
                    <a class="btn-google" href="https://accounts.google.com/o/oauth2/v2/auth?scope=email&access_type=online&response_type=code&redirect_uri=<?= urlencode(Router::route('/google-auth')) ?>&client_id=<?= urlencode($googleClientId) ?>">
