        ...
        <div class="login-container">
            ...
            <?php if( isset($_SESSION['message_inscripttion'])):   ?>
                <div id="confirmation" style="color: green; padding: 10px; border: 1px solid green;">
                    <?php 
                        echo $_SESSION['message_inscripttion'];
            ...
            <form action="/files/RetreatFlow/App_Ver_0_1/src/api/traitement_login.php" method="POST" class="login-form" id="loginForm" name="loginForm">
                <h1>RetraiteFlow</h1>
                ...
                <div class="input-icon aesthetic">
                    ...
                    <input type="email" id="username" name="username" placeholder="Nom utilisateur" required>
                </div>
                ...
                <!-- Champ rôle avec icône -->
                <div class="input-icon aesthetic select-wrapper">
                    <span class="icon-role">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="#0047ab" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M2 17L12 22L22 17" stroke="#0047ab" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M2 12L12 17L22 12" stroke="#0047ab" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </span>
